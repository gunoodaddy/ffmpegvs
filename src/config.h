...
#define FFMPEG_CONFIGURATION "--cross-prefix=i686-w64-mingw32- --arch=i686 --target-os=mingw32 --disable-doc --enable-memalign-hack --enable-runtime-cpudetect --disable-debug --extra-cflags='-Dstrtod=__strtod' --disable-yasm --enable-indev=dshow"
#define FFMPEG_LICENSE "LGPL version 2.1 or later"
#define FFMPEG_DATADIR "/usr/local/share/ffmpeg"
#define AVCONV_DATADIR "/usr/local/share/ffmpeg"
#define CC_IDENT "gcc 4.5.4 (GCC) 20110812 (prerelease)"
...
#define CONFIG_VSINK_FILTER 1
#define CONFIG_ASINK_FILTER 1
#define CONFIG_VSINK_FILTER 1
#define CONFIG_ASINK_FILTER 1
